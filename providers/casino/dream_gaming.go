...
type Win568DreamGaming struct {
	ApiURL     string
	CompanyKey string
	ServerID   string
}

func (p *Win568DreamGaming) StartGame(req providers.LaunchRequest) (string, error) {
	start := time.Now()
...
func init() {
	...
	providers.RegisterProvider("DreamGaming", &Win568DreamGaming{
		ApiURL:     apiURL,
