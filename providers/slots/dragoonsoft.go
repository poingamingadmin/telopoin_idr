...
type Win568Dragoonsoft struct {
	ApiURL     string
	CompanyKey string
	ServerID   string
}

func (p *Win568Dragoonsoft) StartGame(req providers.LaunchRequest) (string, error) {
	start := time.Now()
...
func init() {
	...
	providers.RegisterProvider("Dragoonsoft", &Win568Dragoonsoft{
		ApiURL:     apiURL,
