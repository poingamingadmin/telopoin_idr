...
type Win568MicroGaming struct {
	ApiURL     string
	CompanyKey string
	ServerID   string
}

func (p *Win568MicroGaming) StartGame(req providers.LaunchRequest) (string, error) {
	start := time.Now()
...
func init() {
	...
	providers.RegisterProvider("MicroGaming", &Win568MicroGaming{
		ApiURL:     apiURL,
