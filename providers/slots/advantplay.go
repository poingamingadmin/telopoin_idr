...
type Win568Advanplay struct {
	ApiURL     string
	CompanyKey string
	ServerID   string
}

func (p *Win568Advanplay) StartGame(req providers.LaunchRequest) (string, error) {
	start := time.Now()
...
func init() {
	...
	providers.RegisterProvider("AdvantPlay", &Win568Advanplay{
		ApiURL:     apiURL,
